...
export function Games () {
  const { urbit, displayGame, activeGames, setDisplayGame, displayIndex, setDisplayIndex } = useChessStore()
          ...
          Array.from(activeGames).map(([gameID, activeGame], key) => {
            ...
            return (
              <li
                ...
                title={gameID}
                onClick={() => { setDisplayGame(activeGame); setDisplayIndex(activeGame.info.moves.length - 1) }}>
                <div className='row'>
